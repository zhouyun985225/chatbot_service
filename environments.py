...
if ENVIRONMENT == 'development':
    ...
    WECHAT_APP_ID = os.getenv('WECHAT_APP_ID', 'wxccb38c9242246c0d')
    WECHAT_APP_SECRET = os.getenv('WECHAT_APP_SECRET', '4a55be50bfa9640539c789886f0c442f')
    MYSQL_HOST = os.getenv('MYSQL_HOST', 'ec2-52-81-71-54.cn-north-1.compute.amazonaws.com.cn')
    ...
    REDIS_HOST = os.getenv('REDIS_HOST', 'ec2-52-81-71-54.cn-north-1.compute.amazonaws.com.cn')
    REDIS_PORT = int(os.getenv('REDIS_PORT', '6379'))
    REDIS_PASSWORD = os.getenv('REDIS_PASSWORD', '')
    REDIS_EXPIRE_TIME = int(os.getenv('REDIS_EXPIRE_TIME', '7200'))
    IR_SERVICE_URL = os.getenv('IR_SERVICE_URL', 'http://ec2-52-81-71-54.cn-north-1.compute.amazonaws.com.cn:9001/android')
    CLASSIFY_URL = os.getenv('CLASSIFY_URL', "http://ec2-52-81-71-54.cn-north-1.compute.amazonaws.com.cn:9000/android?q={0}&classify={1}")
else:
